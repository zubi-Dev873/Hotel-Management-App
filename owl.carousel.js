...
;(function($, window, document, undefined) {
	...
	Owl.prototype.initialize = function() {
		...
		// create stage
		this.$stage = $('<' + this.settings.stageElement + ' className="' + this.settings.stageclassName + '"/>')
			.wrap('<div className="' + this.settings.stageOuterclassName + '"/>');
		...
		var tnLink,
			...
			create = function(path) {
				...
				if (settings.lazyLoad) {
					tnLink = '<div className="owl-video-tn ' + lazyclassName + '" ' + srcType + '="' + path + '"></div>';
				} else {
